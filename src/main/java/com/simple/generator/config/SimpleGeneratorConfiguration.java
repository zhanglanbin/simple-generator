...
public class SimpleGeneratorConfiguration implements Serializable, Cloneable {
	...
	@Override  
    public Object clone() {  
		SimpleGeneratorConfiguration simpleGeneratorConfiguration = null;  
        try{  
        	simpleGeneratorConfiguration = (SimpleGeneratorConfiguration)super.clone();  
        }catch(CloneNotSupportedException e) {  
            e.printStackTrace();  
        }  
        return simpleGeneratorConfiguration;  
    }  
}