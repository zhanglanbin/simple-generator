...
@Service
public class SwaggerJavaConfigServiceImpl implements GenerateService {
	...
	public boolean generate() {
		String writerPath = GeneratorUtils.analysisFilePath(simpleGeneratorConfigurationDTO.getProjectPath(), simpleGeneratorConfigurationDTO.getSwaggerConfigPackagePath())
				+ File.separatorChar + simpleGeneratorConfigurationDTO.getSwaggerConfigClassName() + ".java";
		...
		return generatroService.templateAnalysisGenerateFile(context, writerPath, PathConstant.generatorTemplatePath+"config/", "swaggerJavaConfig");
	}
}
